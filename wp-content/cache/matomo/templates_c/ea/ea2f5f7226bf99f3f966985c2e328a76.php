...
class __TwigTemplate_70b61d05548603348ae2aab57b079f9f extends Template
{
    private $source;
    private $macros = [];
...
<script>\$(document).ready(function () { require('{{ jsNamespace }}').{{ jsClass }}.initElements(); });</script>", "@CoreHome\\_uiControl.twig", "/var/www/html/chalets-et-caviar.dew-it.dev/wp-content/plugins/matomo/app/plugins/CoreHome/templates/_uiControl.twig");
    }
}
