...
// if there's a span with class "cre-price" then add a space between the price and the currency symbol (€) and after the currency symbol
...
for (let i = 0; i < priceElements.length; i++) {
    ...
    priceElement.innerHTML = priceElement.innerHTML.replace(/(€)/g, '$1 ');
}
